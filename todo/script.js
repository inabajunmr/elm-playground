	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SubmitComment':
				var index = msg.a;
				var value = msg.b;
				var todo = A2(author$project$Main$get, index, model.todos);
				if (todo.$ === 'Just') {
					var a = todo.a;
					var todos = A3(
						...
						_Utils_update(
							a,
							{
								comments: A2(elm$core$List$cons, value, a.comments)
							}),
						model.todos);
					return _Utils_Tuple2(
						_Utils_update(
...
var author$project$Main$InputComment = F2(
	function (a, b) {
		return {$: 'InputComment', a: a, b: b};
	});
var author$project$Main$SubmitComment = F2(
	function (a, b) {
