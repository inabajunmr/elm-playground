...
var author$project$Main$Tap = function (a) {
	return {$: 'Tap', a: a};
};
var author$project$Main$getMark = function (val) {
	return _Utils_eq(val, -1) ? '×' : ((val === 1) ? '○' : '-');
};
var author$project$Main$Batsu = {$: 'Batsu'};
var author$project$Main$Maru = {$: 'Maru'};
...
var author$project$Main$getLine = F2(
	function (_n0, model) {
		var index1 = _n0.a;
		var index2 = _n0.b;
		var index3 = _n0.c;
		return _Utils_Tuple3(
			A2(elm$core$Array$get, index1, model),
			A2(elm$core$Array$get, index2, model),
			A2(elm$core$Array$get, index3, model));
	});
...
var author$project$Main$judgeLine = function (_n0) {
	var val1 = _n0.a;
	var val2 = _n0.b;
	var val3 = _n0.c;
	var sum = (A2(elm$core$Maybe$withDefault, 0, val1) + A2(elm$core$Maybe$withDefault, 0, val2)) + A2(elm$core$Maybe$withDefault, 0, val3);
	return _Utils_eq(sum, -3) ? author$project$Main$Batsu : ((sum === 3) ? author$project$Main$Maru : author$project$Main$None);
};
...
var author$project$Main$judge = function (model) {
	var patterns = _List_fromArray(
		[
			_Utils_Tuple3(0, 1, 2),
			_Utils_Tuple3(3, 4, 5),
			_Utils_Tuple3(6, 7, 8),
	...
	var judgeList = A2(
		elm$core$List$map,
		author$project$Main$judgeLine,
		A2(
			elm$core$List$map,
			function (v) {
				return A2(author$project$Main$getLine, v, model);
			},
			patterns));
	return (elm$core$List$length(
		A2(
			...
			function (v) {
				return _Utils_eq(v, author$project$Main$Maru);
			},
			judgeList)) > 0) ? author$project$Main$Maru : ((elm$core$List$length(
		A2(
			elm$core$List$filter,
			function (v) {
				return _Utils_eq(v, author$project$Main$Batsu);
			},
			judgeList)) > 0) ? author$project$Main$Batsu : author$project$Main$None);
};
...
var author$project$Main$viewCell = F2(
	function (index, model) {
		var maybe = A2(elm$core$Array$get, index, model);
		var value = function () {
			if (maybe.$ === 'Just') {
				var val = maybe.a;
				return val;
		...
		return ((!value) && _Utils_eq(
			author$project$Main$judge(model),
			author$project$Main$None)) ? A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('s'),
					elm$html$Html$Events$onClick(
					author$project$Main$Tap(index))
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Tap":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));